...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::HomeBook.Client.Models.RecipeResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::HomeBook.Client.Models.RecipeResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::HomeBook.Client.Models.RecipeResponse();
        }
        /// <summary>
